...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "Eat food to grow, but make sure you don't walk over your own tail!";
	...
	private void setFoodLocation() {
		...
		Location l;
		do
			l = new Location(rng.nextInt(WIDTH), rng.nextInt(HEIGHT));
	...
	private void gameOver() {
		...
		String[] arr = {"Yes", "No"};
		int input = JOptionPane.showOptionDialog(null, "Want to play again?", "YOUR SNAKE DIED", 0, -1, null, arr, 0);
